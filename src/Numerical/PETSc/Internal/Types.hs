...
petscBoolCToBool 0 = False
petscBoolCToBool _ = True

boolToPetscBoolC :: Bool -> PetscBool
boolToPetscBoolC True = 1
boolToPetscBoolC False = 0
...
data KspConvergedReason
  = KspConvergedRtolNormal
  | KspConvergedAtolNormal
  | KspConvergedRtol
  | KspConvergedAtol
  | KspConvergedIts
  | KspConvergedCgNegCurv
  | KspConvergedCgConstrained
  | KspConvergedStepLength
  | KspConvergedHappyBreakdown
  | KspDivergedNull
  | KspDivergedIts
  | KspDivergedDtol
  | KspDivergedBreakdown
  | KspDivergedBreakdownBicg
  | KspDivergedNonsymm
  | KspDivergedIndefPC
  | KspDivergedNaNorInf
  | KspDivergedIndefMat
...
data SnesConvergedReason
  = SnesConvergedFnormAbs
...
data TsConvergedReason_
  = TsConvergedIterating
  | TsConvergedTime
  | TsConvergedIts
  | TsConvergedUser
  | TsConvergedEvent
  | TsDivergedNonlinSolve
...
data PetscViewerFormat_
  = ViewFmtDefault
  | ViewFmtAsciiMatlab
  | ViewFmtAsciiMathematica
  | ViewFmtAsciiImpl
  | ViewFmtAsciiInfo
  | ViewFmtAsciiInfoDetail
  | ViewFmtAsciiCommon
  | ViewFmtAsciiSymmodu
  | ViewFmtAsciiIndex
  | ViewFmtAsciiDense
  | ViewFmtAsciiMatrixMarket
  | ViewFmtAsciiVtk
  | ViewFmtAsciiVtkCell
  | ViewFmtAsciiVtkCoords
  | ViewFmtAsciiPcice
  | ViewFmtAsciiPython
  | ViewFmtAsciiFactorInfo
  | ViewFmtAsciiLatex
  | ViewFmtDrawBasci
  | ViewFmtDrawLg
  | ViewFmtDrawContour
...
fileModeToInt :: PetscFileMode_ -> Int
...
-- -- Comm
newtype Comm = Comm {unComm :: CInt} deriving (Eq, Show)
